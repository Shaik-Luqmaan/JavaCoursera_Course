...
public class CommonWords {
    public String[] getCommon(){
        FileResource resource =
                new FileResource("/home/luqmaan/Desktop/Course2/CommonWords/data/common.txt");
...
//                  "likeit.txt", "macbeth.txt", "romeo.txt"};
        ...
        for(int k=0; k < plays.length; k++){
            FileResource resource = new FileResource("/home/luqmaan/Desktop/Course2/CommonWords/data/" + plays[k]);
